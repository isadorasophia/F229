...
\section{Análise dos resultados}
	...
	\subsection{Gráfico de Calibração do Termopar}
		...
		\subsubsection{Achando a relação entre valores de$\Delta V$ e valores de $\Delta T$}
			\begin{table}[H]
				\caption{Valores obtidos de diferença de potencial elétrico em função da maior
				temperatura}
			...
			À partir dessa tabela e da menor temperatura $T_{gelo}=(2\pm5)\cdot10^{-1}\unit{^{\circ}C}$que
			acontecia num bequer cheio de gelo tem-se que:
		...
		\subsubsection{Método dos Mínimos Quadrados}
			...
			Para realizar o método dos mínimos quadrados faremos $y=\Delta V$
			e $x=\Delta T$
