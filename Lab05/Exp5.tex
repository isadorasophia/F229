...
\section{Procedimentos e coleta de dados}
	...
	\subsection{Procedimento}
		...
		Para realização do experimento, um tubo de vidro foi preenchido com uma mistura de agua de glicerina e, colocamos uma haste graduada de modo que pudéssemos saber a distancia da parte até a parte baixo e que quando as esferas atingissem a haste superior, elas ja estariam com sua velocidade limite.Pegamos 5 esferas metalicas maciças $a,b,c,d,e$ de diâmetros diferentes, cujos diâmetros estão expressos na Tabela 2 e a colocávamos dentro do liquido e cronometramos o tempo que elas demoravam para atingir a haste inferior, cujos os dados estão na Tabela 3.
