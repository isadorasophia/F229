...
\section{Resumo}
	...
	o coeficiente de viscosidade do meio $\eta$ com o valor de $\left(8\pm2\right)\cdot10^{-1}\unit{\cdot Pa\cdot s}$
	Pa$\cdot$s, qualificando as propriedades da viscosidade da mistura
