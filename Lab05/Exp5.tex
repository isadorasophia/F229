...
\section{Resumo}
	...
	Sabendo a fórmula da força de empuxo $F_{E}=\cfrac{g\rho'4\pi r^{3}}{3}$,
	com $g$ sendo a aceleração da gravidade (dada por 9,8 +/- 0,2 m/s$^{2}$),
	$\rho_{f}$ a densidade do fluido e $r$ o raio da esfera; a força
	peso $F_{P}=\cfrac{g\rho4\pi r^{3}}{3}$, com $\rho_{e}$ sendo a
	densidade da esfera; e a força de viscosidade $F_{V}=6\pi\eta rv$,
	...
	força viscosa deve ser corrigida com o fator de Ladenburg $K=\bigg(\cfrac{1+2,4r}{A}\bigg)\cdot\bigg(\cfrac{1+3,3r}{H}\bigg)$,
	em que $A$ é o raio do tubo e $H$ é a altura total do fluido no
	...
	o coeficiente de viscosidade do meio $\eta$ com o valor de $8\cdot10^{-1}$
	+/- $2\cdot10^{-1}$ Pa$\cdot$s, qualificando as propriedades da
	viscosidade da mistura de glicerina e água e que, por sua vez, permitiu
	concluir uma concentracão de água na mistura de $(95\pm5)\%$.
