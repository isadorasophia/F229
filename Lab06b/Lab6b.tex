	...
	\section{Procedimentos e coleta de dados}
		...
		\subsection{Procedimento}
			...
			\subsubsection{Parte 1: Obtenção do calor específico dos metais}
				...
				\begin{table}[!ht]
					\caption{Valores medidos experimentalmente conforme expresso acima para a obtenção
					do calor especifico dos metais}
					...
					\begin{tabular}{|c|c|rl|rl|rl|}
						...
						\end{tabular} & 
						\multicolumn{2}{c|}{Para o metal $a$} & 
						\multicolumn{2}{c|}{Para o metal $b$} & 
						\multicolumn{2}{c|}{Para o metal $c$}\tabularnewline
						\hline 
						Massa do copo vazio  & $m_{c+\varnothing}$  & $\left(5,97\pm0,01\right)$  & $\cdot10^{1}\unit{g}$  & $\left(5,97\pm0,01\right)$  & $\cdot10^{1}\unit{g}$  & $\left(5,97\pm0,01\right)$  & $\cdot10^{1}\unit{g}$\tabularnewline
						\hline 
						Massa do copo com água  & $m_{c+a}$  & $\left(2,442\pm0,001\right)$  & $\cdot10^{2}\unit{g}$  & $\left(2,132\pm0,001\right)$  & $\cdot10^{2}\unit{g}$  & $\left(2,126\pm0,001\right)$  & $\cdot10^{2}\unit{g}$\tabularnewline
						\hline 
						Massa de água  & $m_{a}$  & $\left(1,825\pm0,001\right)$  & $\cdot10^{2}\unit{g}$  & $\left(1,535\pm0,001\right)$  & $\cdot10^{2}\unit{g}$  & $\left(1,529\pm0,001\right)$  & $\cdot10^{2}\unit{g}$\tabularnewline
						\hline 
						Temperatura da água  & $T_{a}$  & $\left(2,0\pm0,1\right)$  & $\cdot10^{1}\unit{^{\circ}C}$  & $\left(1,3\pm0,1\right)$  & $\cdot10^{1}\unit{^{\circ}C}$  & $\left(2,1\pm0,1\right)$  & $\cdot10^{1}\unit{^{\circ}C}$\tabularnewline
						\hline 
						Temperatura do metal  & $T_{q}$  & $\left(8,0\pm0,1\right)$  & $\cdot10^{1}\unit{^{\circ}C}$  & $\left(8,0\pm0,1\right)$  & $\cdot10^{1}\unit{^{\circ}C}$  & $\left(8,2\pm0,1\right)$  & $\cdot10^{1}\unit{^{\circ}C}$\tabularnewline
						\hline 
						Massa do metal  & $m_{M}$  & $\left(9,09\pm0,01\right)$  & $\cdot10^{1}\unit{g}$  & $\left(4,20\pm0,01\right)$  & $\cdot10^{1}\unit{g}$  & $\left(1,012\pm0,001\right)$  & $\cdot10^{2}\unit{g}$\tabularnewline
						\hline 
						Temperatura de equilíbrio  & $T_{e}$  & $\left(2,3\pm0,1\right)$  & $\cdot10^{1}\unit{\unit{^{\circ}C}}$  & $\left(2,0\pm0,1\right)$  & $\cdot10^{1}\unit{\unit{^{\circ}C}}$  & $\left(2,3\pm0,1\right)$  & $\cdot10^{1}\unit{\unit{^{\circ}C}}$\tabularnewline
						\hline 
					\end{tabular}
				\end{table}
			...
			\subsubsection{Parte 2: Calor latente de fusão do gelo}
				...
				\newpage{}
						...
						\begin{table}[!ht]
                			\caption{Valores medidos experimentalmente conforme expresso acima para a obtenção
                			do calor latente de fusão do gelo}
                			...
                			\begin{tabular}{|c|c|rl|}
                				...
                				\hline 
                				Massa do copo vazio  & $m_{c+\varnothing}$  & $\left(5,97\pm0,01\right)$  & $\cdot10^{1}\unit{g}$ \tabularnewline
                				\hline 
                				Massa do copo com água  & $m_{c+a}$  & $\left(1,908\pm0,001\right)$  & $\cdot10^{2}\unit{g}$ \tabularnewline
                				\hline 
                				Massa de água  & $m_{a}$  & $\left(1,311\pm0,001\right)$  & $\cdot10^{2}\unit{g}$ \tabularnewline
                				\hline 
                				Temperatura da água  & $T_{a}$  & $\left(3,9\pm0,1\right)$  & $\cdot10^{1}\unit{^{\circ}C}$ \tabularnewline
                				\hline 
                				Massa do béquer vazio  & $m_{b+\varnothing}$  & $\left(5,82\pm0,01\right)$  & $\cdot10^{1}\unit{g}$ \tabularnewline
                				\hline 
                				Massa do béquer com gelo  & $m_{b+a}$  & $\left(8,57\pm0,01\right)$  & $\cdot10^{1}\unit{g}$ \tabularnewline
                				\hline 
                				Massa de gelo  & $m_{g}$  & $\left(2,75\pm0,01\right)$  & $\cdot10^{1}\unit{g}$ \tabularnewline
                				\hline 
                				Temperatura do gelo  & $T_{g}$  & $\left(0\pm1\right)$  & $\unit{^{\circ}C}$ \tabularnewline
                				\hline 
