...
\begin{document}
	...
	\section{Procedimentos e coleta de dados}
		...
		\subsubsection{Parte 1: Obtenção do calor específico dos metais}
			...
			ser o euilíbrio do sistema e medimos essa temperatura. 
			...
			\subsubsection{Análise crítica dos resultados}
				...
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						então esta água pode ter uma temepratura real no inicio do 
					...
					\begin{enumerate}
						\item A realização de uma única medida para a capacidade térmica, leva em conta apenas a propagação dos erros instrumentais do termometro e da balança, mas não leva em conta o erro estatístico que provavelmente se manifestaria em decorrencia de erros aleatórios como a dissipação de calor por:
						\begin{enumerate}
